...
public class Home extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<body>"
				+ "    <div class=\"container\">"
				+" <h3 style = 'color :green;'>WELCOME  "+empname+"<h3>"
				
				+ " <form class=\"form\" name=\"Timesheet\" action=\"UpdateTimesheet\" method=\"post\">"
				+ "  <div class=\"row\">"
				...
				+ "<div class=\"col-md-4\">"
				+ "<input type=\"number\" max=\"31\" name=\"workingDays\" class=\"form-control\">"
				+ "</div>"
